...
resource "aws_s3_bucket" "theradex_qrcg_codepipeline_bucket" {
  bucket = "theradex-qrcodegeneration-serverless-production-nci-artifacts"
}
resource "aws_s3_bucket_server_side_encryption_configuration" "theradex_qrcg_codepipeline_bucket_encryption" {
  bucket = "theradex-qrcodegeneration-serverless-production-nci-artifacts"
  rule {
...
resource "aws_s3_bucket" "theradex_qrcg_app_bucket" {
  bucket = "theradex-qrcode-production-nci"
}
