...
resource "aws_scheduler_schedule" "etctn-async_download-preanalytics_scheduler" {
  ...
  start_date = "2024-08-15T05:05:00Z" //05:05am UTC to 12:05am EST
  ...
  target {
    ...
    input = jsonencode({ "form_oid" : "PREANALYTIC_RESULTS", "query_id" : 16, "protocols" : [10330, 10355, 10358, 10388, 10434, 10440, 10499, 10579, 10538, 10563] })
...
resource "aws_scheduler_schedule" "etctn-async_download-solidtissue_scheduler" {
  ...
  start_date = "2024-08-15T05:15:00Z" //05:15am UTC to 12:15am EST
  ...
  target {
    ...
    input = jsonencode({ "form_oid" : "SOLID_TISSUE_PATHOLOGY_VERIFICATION_AND_ASSESSMENT", "query_id" : 15, "protocols" : [10330, 10355, 10358, 10388, 10434, 10440, 10499, 10579, 10538, 10563] })
...
resource "aws_scheduler_schedule" "etctn-async_download-hematology_scheduler" {
  ...
  start_date = "2024-08-15T05:25:00Z" //05:25am UTC to 12:25am EST
  ...
  target {
    ...
    input = jsonencode({ "form_oid" : "HEMATOLOGIC_MALIGNANCY_VERIFICATION_AND_ASSESSMENT", "query_id" : 15, "protocols" : [10330, 10355, 10358, 10388, 10434, 10440, 10499, 10579, 10538, 10563] })
...
resource "aws_scheduler_schedule" "etctn-async_download-shippingstatus_scheduler" {
  ...
  start_date = "2024-08-15T05:35:00Z" //05:35am UTC to 12:35am EST
  ...
  target {
    ...
    input = jsonencode({ "form_oid" : "SHIPPING_STATUS", "query_id" : 17, "protocols" : [10330, 10355, 10358, 10388, 10434, 10440, 10499, 10579, 10538, 10563] })
...
resource "aws_scheduler_schedule" "etctn-async_download-receivingstatus_scheduler" {
  ...
  start_date = "2024-08-15T05:45:00Z" //05:45am UTC to 12:45am EST
  ...
  target {
    ...
    input = jsonencode({ "form_oid" : "RECEIVING_STATUS", "query_id" : 18, "protocols" : [10330, 10355, 10358, 10388, 10434, 10440, 10499, 10579, 10538, 10563] })
...
resource "aws_scheduler_schedule" "etctn-async_download-inventory_scheduler" {
  ...
  start_date = "2024-08-15T05:55:00Z" //05:55am UTC to 12:55am EST
  ...
  target {
    ...
    input = jsonencode({ "form_oid" : "EET_INVENTORY", "query_id" : 14, "protocols" : [10330, 10355, 10358, 10388, 10434, 10440, 10499, 10579, 10538, 10563] })
