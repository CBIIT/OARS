#------------------------------------------
# Setup FedRAMP(Moderate) conformance pack
#------------------------------------------

resource "aws_config_conformance_pack" "FedRAMP-Moderate" {
...
Parameters:
  ...
  AcmCertificateExpirationCheckParamDaysToExpiration:
    Default: '90'
    Type: String
  BackupParamFrequencyUnit:
    Default: days
    Type: String
  BackupParamFrequencyValue:
    Default: '1'
    Type: String
  BackupParamRetentionDays:
    Default: '35'
    Type: String
  ...
  IamInlinePolicyBlockedKmsActionsParamBlockedActionsPatterns:
    Default: kms:Decrypt,kms:ReEncryptFrom
    Type: String
  IamPwPolPmMaxPasswordAge:
    Default: '90'
    Type: String
  IamPwPolPmMinimumPasswordLength:
    Default: '14'
    Type: String
  IamPwPolPmPasswordReusePrevention:
    Default: '24'
    Type: String
  IamPwPolPmRequireLowercaseCharacters:
    Default: 'true'
    Type: String
  IamPwPolPmRequireNumbers:
    Default: 'true'
    Type: String
  IamPwPolPmRequireSymbols:
    Default: 'true'
    Type: String
  IamPwPolPmRequireUppercaseCharacters:
    Default: 'true'
    Type: String
    ...
    Properties:
      ...
      InputParameters:
        MaxPasswordAge:
          ...
          - Ref: IamPwPolPmMaxPasswordAge
          - Ref: AWS::NoValue
        MinimumPasswordLength:
          Fn::If:
          - iamPasswordPolicyParamMinimumPasswordLength
          - Ref: IamPwPolPmMinimumPasswordLength
          - Ref: AWS::NoValue
        PasswordReusePrevention:
          Fn::If:
          - iamPasswordPolicyParamPasswordReusePrevention
          - Ref: IamPwPolPmPasswordReusePrevention
          - Ref: AWS::NoValue
        RequireLowercaseCharacters:
          Fn::If:
          - iamPasswordPolicyParamRequireLowercaseCharacters
          - Ref: IamPwPolPmRequireLowercaseCharacters
          - Ref: AWS::NoValue
        RequireNumbers:
          Fn::If:
          - iamPasswordPolicyParamRequireNumbers
          - Ref: IamPwPolPmRequireNumbers
          - Ref: AWS::NoValue
        RequireSymbols:
          Fn::If:
          - iamPasswordPolicyParamRequireSymbols
          - Ref: IamPwPolPmRequireSymbols
          - Ref: AWS::NoValue
        RequireUppercaseCharacters:
          Fn::If:
          - iamPasswordPolicyParamRequireUppercaseCharacters
          - Ref: IamPwPolPmRequireUppercaseCharacters
          - Ref: AWS::NoValue
      Source:
        Owner: AWS
