...
resource "aws_config_conformance_pack" "FDA-Title-21-CFR-PART-11" {
  name = "FDA-Title-21-CFR-PART-11"
...
#
#   This conformance pack helps verify compliance with Title 21 CFR Part 11 requirements.
#
...
Resources:
  ...
  IamPasswordPolicy2:
    Properties:
      ConfigRuleName: iam-password-policy-2
      Source:
        Owner: AWS
        SourceIdentifier: IAM_PASSWORD_POLICY
    Type: AWS::Config::ConfigRule
