...
CREATE TABLE WRUSER.WRCONTACTUSCATEGORY
(
  WRCONTACTUSCATEGORYID  NUMBER GENERATED ALWAYS AS IDENTITY ( START WITH 1 MAXVALUE 9999999999999999999999999999 MINVALUE 1 CYCLE CACHE 20 ORDER KEEP NOSCALE) NOT NULL,
  NAME                   VARCHAR2(100 BYTE)     NOT NULL,
  PARENTCATEGORYID       NUMBER                     NULL,
  EMAILTO                VARCHAR2(100 BYTE)         NULL,
  "ORDER"                NUMBER                     NULL,
  CREATEDATE             TIMESTAMP(6)               NULL,
  UPDATEDATE             TIMESTAMP(6)               NULL
)
...
ALTER TABLE WRUSER.WRCONTACTUSCATEGORY ADD (
  CONSTRAINT WRCONTACTUSCATEGORY_PK
  PRIMARY KEY
  (WRCONTACTUSCATEGORYID)
  ENABLE VALIDATE);


CREATE TABLE WRUSER.WRCONTACTUS
(
  WRCONTACTUSID  NUMBER GENERATED ALWAYS AS IDENTITY ( START WITH 1 MAXVALUE 9999999999999999999999999999 MINVALUE 1 CYCLE CACHE 20 ORDER KEEP NOSCALE) NOT NULL,
  SUBJECT        VARCHAR2(200 BYTE)                 NULL,
  DESCRIPTION    VARCHAR2(4000 BYTE)                NULL,
  CATEGORYID     NUMBER                         NOT NULL,
  CREATEDATE     TIMESTAMP(6)                       NULL,
  USERID	NUMBER								NULL,
  ATTACHMENTNAME	VARCHAR2 (100 BYTE)					NULL
)
TABLESPACE CDR_DATA
PCTFREE    10
INITRANS   1
...
ALTER TABLE WRUSER.WRCONTACTUS ADD (
  CONSTRAINT WRCONTACTUS_PK
  PRIMARY KEY
  (WRCONTACTUSID)
  ENABLE VALIDATE);
...
ALTER TABLE WRUSER.WRCONTACTUS ADD (
  ...
  REFERENCES WRUSER.WRCONTACTUSCATEGORY (WRCONTACTUSCATEGORYID)
  ENABLE VALIDATE);

  ALTER TABLE WRUSER.WRCONTACTUS
ADD CONSTRAINT FK_USERID_WRUSER 
  FOREIGN KEY (USERID) 
  REFERENCES WRUSER.WRUSER (USERID)
  ENABLE VALIDATE;

  CREATE TABLE "WRUSER"."WRERRORLOG" 
   (	"WRERRORLOGID" NUMBER GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 ORDER  CYCLE  KEEP  NOSCALE  NOT NULL ENABLE, 
	"CREATE_DATE" TIMESTAMP (6), 
	"USERID" NUMBER, 
 ...
 NOCOMPRESS LOGGING
  ...
  GRANT SELECT ON "WRUSER"."WRERRORLOG" TO "WRUSER_READ";
