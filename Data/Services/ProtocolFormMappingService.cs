...
namespace TheradexPortal.Data.Services
{
    public class ProtocolFormMappingService : BaseService, IProtocolFormMappingService
    {
        ...
        public ProtocolFormMappingService(IDbContextFactory<ThorDBContext> dbFactory, IErrorLogService errorLogService, NavigationManager navigationManager) : base(dbFactory)
        {
